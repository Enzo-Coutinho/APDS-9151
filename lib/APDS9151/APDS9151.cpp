...
void initalize()
{
    ...
    ESP_ERROR_CHECK(i2c_master_bus_add_device(i2c_bus_handle, &apds9151_i2c_configure, &apds9151_dev_handle));
}
...
{
    uint8_t partId;
    ESP_ERROR_CHECK(read_register(registers::__MAIN_STATUS_ADDR, 1, &partId));
    return partId;
}
