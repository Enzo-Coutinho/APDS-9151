...
void setup() {
  Serial.begin(115200);
  initalize();
  uint8_t initial_configure[2] = {registers::__MAIN_CTRL_ADDR, data_main_ctrl::__RGB_MODE | data_main_ctrl::__LS_EN | data_main_ctrl::__PS_EN | data_main_ctrl::__SW_RESET};
...
void loop() {
  Serial.println(get_ls_data_blue());
}